...
return {
	...
	{"channelCreate", "Emitted when a guild channel is created, when a private channel is opened, or when a group channel is joined.", {"channel", "the created channel", "Channel"}},
	{"channelUpdate", "Emitted when a channel property is updated, such as its name, topic, bitrate, etc.", {"channel", "the updated channel", "Channel"}},
	{"channelDelete", "Emitted when a guild channel is deleted, when a private channel is closed, or when a group channel is left.", {"channel", "the deleted channel", "Channel"}},
	{"recipientAdd", "Emitted when a new recipient is added to a group channel. User", {"channel", "the group channel to which the user was added", "Channel"}, {"user", "the user that was added", "User"}},
	{"recipientRemove", "Emitted when a new recipient is removed from a group channel. User", {"channel", "the group channel from which the user was removed", "Channel"}, {"user", "the user that was removed", "User"}},
	...
	{"messageUpdateUncached", "Emitted when the content of a text channel message is edited, but the message is not cached by the client.", {"channel", "the channel in which the message was created", "Channel"}, {"messageId", "the Snowflake ID of the message", "Message"}},
	...
	{"messageDeleteUncached", "Emitted when a text channel message is deleted, but the message is not cached by the client. Bulk deletions will fire this for every message that is deleted, but not cached.", {"channel", "the channel in which the message was created", "Channel"}, {"messageId", "the Snowflake ID of the message", "Message"}},
	...
	{"reactionAddAny", "Emitted when an emoji reaction is added to message, whether the message is cached or not.\n  This event will be emitted before `reactionAdd`/`reactionAddUncached` are emitted.", {"channel", "the channel in which the reaction was added", "Channel"}, {"messageId", "The Snowflake ID of the reacted message", "Message"}, {"hash", "the hash of the reaction; either an emoji ID or emoji name", "string"}, {"userId", "the Snowflake ID of the user that added the reaction", "string"}},
	{"reactionAddUncached", "Emitted when an emoji reaction is added to message, but the message is not cached by the client.", {"channel", "the channel in which the reaction was added", "Channel"}, {"messageId", "the Snowflake ID of the reacted message", "Message"}, {"hash", "the hash of the reaction; either an emoji ID or emoji name", "string"}, {"userId", "the Snowflake ID of the user that added the reaction", "string"}},
	...
	{"reactionRemoveAny", "Emitted when an emoji reaction is removed from a message, whether the message is cached or not.\n  This event will be emitted before `reactionRemove`/`reactionRemoveUncached` are emitted.", {"channel", "the channel in which the reaction was removed", "Channel"}, {"messageId", "the Snowflake ID of the reacted message", "Message"}, {"hash", "the hash of the reaction; either an emoji ID or emoji name", "string"}, {"userId", "the Snowflake ID of the user whose reaction was removed", "string"}},
	{"reactionRemoveUncached", "Emitted when an emoji reaction is removed from a message, but the message is not cached by the client.", {"channel", "the channel in which the reaction was removed", "Channel"}, {"messageId", "the Snowflake ID of the reacted message", "Message"}, {"hash", "the hash of the reaction; either an emoji ID or emoji name", "string"}, {"userId", "the Snowflake ID of the user whose reaction was removed", "string"}},
	...
	{"reactionRemoveAllAny", "Emitted when all emoji reactions are removed from a message, whether the message is cached or not.\n  This event will be emitted before `reactionRemoveAll`/`reactionRemoveAllUncached` are emitted.", {"channel", "the channel in which the reactions were removed", "Channel"}, {"messageId", "the Snowflake ID of the reacted message", "Message"}},
	{"reactionRemoveAllUncached", "Emitted when all emoji reactions are removed from a message, but the message is not cached by the client.", {"channel", "the channel in which the reactions were removed", "Channel"}, {"messageId", "the Snowflake ID of the reacted message", "Message"}},
	{"pinsUpdate", "Emitted when a message is pinned or unpinned in a channel.", {"channel", "the channel in which the message was pinned or unpinned", "Channel"}},
	...
	{"relationshipUpdate", "Emitted when a relationship's (friend, blocked user)  status or user properties change. User", {"relationship", "the relationship that was updated", "Relationship"}},
	{"relationshipAdd", "Emitted when a relationship (friend, blocked user) is added. User", {"relationship", "the relationship that was added", "Relationship"}},
	{"relationshipRemove", "Emitted when a relationship (friend, blocked user) is removed. User", {"relationship", "the relationship that was removed", "Relationship"}},
	{"typingStart", "Emitted when a user starts typing in a text channel.", {"userId", "the Snowflake ID of the user that started typing", "string"}, {"channelId", "the Snowflake ID of the channel in which the user started typing", "Channel"}, {"timestamp", "Unix timestamp in seconds at which the user started typing", "string"}},
	...
	{"voiceChannelJoin", "Emitted when a guild member joins a voice channel.", {"member", "the member that joined", "Member"}, {"channel", "the channel that was joined", "Channel"}},
	{"voiceChannelLeave", "Emitted when a guild member leaves a voice channel.", {"member", "the member that left", "Member"}, {"channel", "the channel that was left", "Channel"}},
	{"webhooksUpdate", "Emitted when a guild's text channel's webhooks have updated.", {"channel", "the channel in which the webhook updated", "Channel"}},
