...
return {
	...
	{"recipientAdd", "Emitted when a new recipient is added to a group channel. User-accounts only.", {"channel", "the group channel to which the user was added", "Channel"}, {"user", "the user that was added", "User"}},
	{"recipientRemove", "Emitted when a new recipient is removed from a group channel. User-accounts only.", {"channel", "the group channel from which the user was removed", "Channel"}, {"user", "the user that was removed", "User"}},
	...
	{"messageUpdateUncached", "Emitted when the content of a text channel message is edited, but the message is not cached by the client.", {"channel", "the channel in which the message was created", "Channel"}, {"messageId", "the Snowflake ID of the message", "string"}},
	...
	{"reactionRemoveAny", "Emitted when an emoji reaction is removed from a message, whether the message is cached or not.", {"channel", "the channel in which the reaction was removed", "Channel"}, {"messageId", "the Snowflake ID of the reacted message", "string"}, {"hash", "the hash of the reaction; either an emoji ID or emoji name", "string"}, {"userId", "the Snowflake ID of the user whose reaction was removed", "string"}},
	...
	{"reactionRemoveAllAny", "Emitted when all emoji reactions are removed from a message, whether the message is cached or not.", {"channel", "the channel in which the reactions were removed", "Channel"}, {"messageId", "the Snowflake ID of the reacted message", "string"}},
	{"reactionRemoveAllUncached", "Emitted when all emoji reactions are removed from a message, but the message is not cached by the client.", {"channel", "the channel in which the reactions were removed", "Channel"}, {"messageId", "the Snowflake ID of the reacted message", "string"}},
