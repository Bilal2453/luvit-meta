...
---
---**Note**: Use `@cast` when injecting the extensions, like examples below.
---
...
---```lua
--- ---@cast string +discordia.extensions.string
...
---```lua
--- ---@cast string +discordia.extensions.string
--- ---@cast math +discordia.extensions.math
--- ---@cast table +discordia.extensions.table
--- discordia.extensions()
---```
---
---@class discordia.extensions: table
---@field table discordia.extensions.table
---@field string discordia.extensions.string
---@field math discordia.extensions.math
---@overload fun()
local extensions = {}
...
---@class discordia.extensions.string: table
---@overload fun()
extensions.string = {}
